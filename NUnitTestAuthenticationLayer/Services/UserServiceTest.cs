...
namespace NUnitTestAuthenticationLayer.Services
{
    ...
    {
        [Test, TestCaseSource(typeof(UserTestData), nameof(UserTestData.WrongCreateUserTestCases))]
        ...
        public void SuccsessfulGetReturnsUser(string id)
        {
            ...
            var user = new ApplicationUser
            {
                Id = id,
                Email = "ok",
                Roles = { new IdentityUserRole { UserId = id, RoleId = "test" } },
                ClientProfile = new ClientProfile { Name = "test" }
            };
            var mockStore = new Mock<IUserStore<ApplicationUser>>();
        ...
        [Test, TestCaseSource(typeof(UserTestData), nameof(UserTestData.SuccessfulSetRoleTestCases))]
        ...
        [Test, TestCaseSource(typeof(UserTestData), nameof(UserTestData.WrongSetRoleTestCases))]
